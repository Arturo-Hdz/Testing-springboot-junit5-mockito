...
public class EmpleadoControllerTestRestTemplateTests {
	...
	void testGuardarEMpleado(){
		...
		assertEquals("Juan", empleadoCreado.getNombre());
		assertEquals("Perez", empleadoCreado.getApellido());
		assertEquals("juan@gmail.com", empleadoCreado.getEmail());
	}
	...
	void testListarEmpleados() {
		...
		assertEquals(1L,empleados.size());
		...
		assertEquals("juan@gmail.com", empleados.get(0).getEmail());
	}
	...
	void testObtenerEmpleado() {
		...
		assertEquals("juan@gmail.com", empleado.getEmail());
	}
